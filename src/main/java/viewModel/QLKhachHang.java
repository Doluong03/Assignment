...
public class QLKhachHang {
    ...
    public QLKhachHang(String ma, String ho, String ten_dem, String ten, String ngay_sinh, String sdt, String dia_chi, String thanh_pho, String mat_khau, String quoc_gia) {
        this.ma = ma;
        this.ho = ho;
